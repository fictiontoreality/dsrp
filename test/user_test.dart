...
void main() {
  ...
  group('User object tests', () {
      ...
      group('verifySession tests', () {
          final serverSessionKeyVerifier = Uint8List.fromList([11, 114, 210, 88, 9, 28, 238, 168, 77, 158, 32, 102, 43, 253, 72, 248, 164, 73, 231, 6, 105, 181, 76, 144, 203, 230, 220, 199, 102, 215, 28, 255]);
          ...
          test('verification fails for incorrect server verifier', () {
              expect(user.verifySession(Uint8List.fromList([...serverSessionKeyVerifier, 1, 2, 3, 4])),
