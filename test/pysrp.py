...
print('ephemeralPrivateUserKey:', list(ephemeralPublicUserKey))
print('ephemeralPublicUserKey:', list(ephemeralPublicUserKey))

server = srp.Verifier(USERNAME, DEFAULT_SALT,
                      DEFAULT_VERIFIER_KEY, ephemeralPublicUserKey,
...
sessionKeyVerifier = user.process_challenge(DEFAULT_SALT, ephemeralPublicServerKey)
print('sessionKeyVerifier:', list(sessionKeyVerifier))

serverSessionKeyVerifier = server.verify_session(sessionKeyVerifier)
