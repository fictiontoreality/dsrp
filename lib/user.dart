...
import 'rfc5054.dart';
import 'server.dart' show Challenge;
import 'util.dart';
...
class User {
  ...
  Future<List<int>> processChallenge(Challenge challenge) async {
    sessionKey = await _deriveSessionKey(challenge.salt, challenge.ephemeralServerPublicKey);
    // H(N)
